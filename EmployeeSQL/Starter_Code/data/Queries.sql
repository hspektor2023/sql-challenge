...
SELECT d.dept_no, d.dept_name, depm.emp_no, e.last_name, e.first_name FROM departments d
JOIN department_manager depm
ON d.dept_no = depm.dept_no
JOIN employees e
ON depm.emp_no = e.emp_no;

--List the department number for each employee along with that employee’s employee number, last name, first name, and department name.

SELECT ed.dept_no, ed.emp_no, e.last_name, e.first_name, d.dept_name FROM employees e
